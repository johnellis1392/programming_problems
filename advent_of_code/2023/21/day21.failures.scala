...
def part2_2(input: String): Long =
  ...
  var set1 = HashSet[Point]()
  var frontier1 = HashSet[Point]()
  var set2 = HashSet[Point]()
  var frontier2 = HashSet[Point]()
...
def part2_3(input: String, steps: Int = 6): Long =
  ...
  var prev1 = HashSet[Point]()
  var curr1 = HashSet[Point]()
  var total1 = 1L
  var prev2 = HashSet[Point]()
  var curr2 = HashSet[Point]()
  var total2 = 0L
...
def part2(input: String, steps: Int): Long =
  ...
  var prev = HashSet[Point]()
  var curr = HashSet[Point]()
