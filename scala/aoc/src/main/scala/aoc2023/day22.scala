  ...
  def from(s: String) = 
    ...
    s match
      case line_re(x1, y1, z1, x2, y2, z2) =>
        Cube(
          aoc2015.Point(x1.toInt, y1.toInt, z1.toInt),
          aoc2015.Point(x2.toInt, y2.toInt, z2.toInt)
        )
      case _ => throw new Exception(s"Invalid cube configuration: '$s'")

case class Cube(p1: aoc2015.Point, p2: aoc2015.Point, id: String = Cube.newLabel):
